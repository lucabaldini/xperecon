...
GEM_RUN_DICT = {'gem_1413':{'unif_illumination_runs':[541, 542],
                ...
                'gem_1418':{'unif_illumination_runs':[424, 425, 426,
                           ...
                           'notes':['']},
                'gem_1419':{'unif_illumination_runs':[451, 462],
                           'Top HV':1480, 'Trending time':4.2,
                           'notes':['First 3 runs have a hole in the hitmap,found to be due to a whisker in the GEM','Runs 446, 448 are for gem 1419 but thy have not been reprocessed.']},
                'gem_1420':{'unif_illumination_runs':[469],
                ...
                'gem_1422':{'unif_illumination_runs':[520, 521],
                           ...
                           'notes':['Using new fixture to set uniform illumination made by Davide.','Run 519 is for gem 1422 but it was never rprocessed.']},
}
