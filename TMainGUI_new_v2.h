...
class TMainGUI: public TGMainFrame{
 ...
 private:
  ...
  TInputFile       *PixFileName, *PedFileName, *RawFileName;
  ...
  TGTextEntry      *fPedFileEntry, *fDataFileEntry, *fPedEvEntry, *fDataEvEntry, *fDataEvEntry1 ;
  ...
  Double_t par[3];
  TGTextBuffer *fPName, *fDName, *fEvPed, *fEvData;
